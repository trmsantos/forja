        ...
        <div className="grid gap-12 md:grid-cols-2 md:gap-16">
          {testimonials.map((t, i) => (
            <Reveal key={t.name} delay={i * 0.1}>
              <figure>
                <blockquote className="font-display text-[26px] font-bold leading-tight tracking-tight2 text-ink sm:text-[30px]">
                  <span className="text-ember">&ldquo;</span>
                  {t.quote}
                  <span className="text-ember">&rdquo;</span>
                </blockquote>
                <figcaption className="mt-6 text-[15px] text-ink/55">
